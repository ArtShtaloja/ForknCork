...
// Static files
// ---------------------------------------------------------------------------
app.use(express.static(path.join(__dirname, '../forkncork_frontend/public')));
...
app.get('/', (_req, res) => {
  ...
  res.sendFile(path.join(__dirname, '../forkncork_frontend/views', 'home', 'index.html'));
});

app.get('/menu', (_req, res) => {
  res.sendFile(path.join(__dirname, '../forkncork_frontend/views', 'menu', 'index.html'));
});

app.get('/menu/product', (_req, res) => {
  res.sendFile(path.join(__dirname, '../forkncork_frontend/views', 'menu', 'product.html'));
});

app.get('/contact', (_req, res) => {
  res.sendFile(path.join(__dirname, '../forkncork_frontend/views', 'contact', 'index.html'));
});

app.get('/admin', (_req, res) => {
  res.sendFile(path.join(__dirname, '../forkncork_frontend/views', 'admin', 'login.html'));
});
...
adminDashboardSections.forEach((section) => {
  app.get(`/admin/${section}`, (_req, res) => {
    res.sendFile(path.join(__dirname, '../forkncork_frontend/views', 'admin', 'dashboard.html'));
  });
});
